    ...
    def run_evaluate(self, test):
        ...
        for words, labels in minibatches(test, self.config.batch_size):
            ...
            for lab, lab_pred, length in zip(labels, labels_pred,
                ...
                chunk_correct_preds += len(lab_chunks & lab_pred_chunks)
                chunk_total_preds   += len(lab_pred_chunks)
                chunk_total_correct += len(lab_chunks)
        ...
        chunk_f1 = 2 * chunk_p * chunk_r / (chunk_p + chunk_r) if chunk_correct_preds > 0 else 0
